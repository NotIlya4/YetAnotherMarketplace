...
public class ApplySortingTests
{
    ...
    public async Task PropertyIncrementAllAscAndDesc_SortedEntities(SortingSide sortingSide)
    {
        ...
        IQueryable<QueryableTestEntity> query = StartQuery.ApplySorting(
            primarySorting: new SortingInfo<QueryableTestEntity>(nameof(QueryableTestEntity.Property1), sortingSide),
            secondarySortings: new List<SortingInfo<QueryableTestEntity>>
            {
    ...
    {
        IQueryable<QueryableTestEntity> query = StartQuery.ApplySorting(
            primarySorting: new SortingInfo<QueryableTestEntity>(nameof(QueryableTestEntity.Property2), SortingSide.Asc),
            secondarySortings: new List<SortingInfo<QueryableTestEntity>>
            {
    ...
    {
        IQueryable<QueryableTestEntity> query = StartQuery.ApplySorting(
            primarySorting: new SortingInfo<QueryableTestEntity>(nameof(QueryableTestEntity.Property4), SortingSide.Desc),
            secondarySortings: new List<SortingInfo<QueryableTestEntity>>
            {
